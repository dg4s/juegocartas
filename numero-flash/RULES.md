# NÚMERO FLASH — Reglas del Proyecto

> Nombre histórico: MONTEO NÚMERO (DEC-001). Identidad operativa vigente: **NÚMERO FLASH** (DEC-051).
...
| GO_SIGNAL 500 ms antes del número (rótulo UI: GO, DEC-052) | DEC-032, DEC-052 |
